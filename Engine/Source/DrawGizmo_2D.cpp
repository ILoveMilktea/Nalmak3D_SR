...
void DrawGizmo_2D::Initialize()
{
	...
	m_rightPositionHandle->GetComponent<CanvasRenderer>()->SetColor({ 1.f,0.f,0.f,1.f });
	...
	m_upPositionHandle->GetComponent<CanvasRenderer>()->SetColor({ 0.f,1.f,0.f,1.f });
	...
	m_rightScaleHandle =
		...
		SetScale(20.f, 20.f);
	//m_rightHandle->SetParents(m_gameObject);
	m_rightScaleHandle->GetComponent<CanvasRenderer>()->SetColor({ 1.f,0.f,0.f,1.f });
	...
	m_upScaleHandle =
		...
		SetScale(20.f, 20.f);
	//m_upHandle->SetParents(m_gameObject);
	m_upScaleHandle->GetComponent<CanvasRenderer>()->SetColor({ 0.f,1.f,0.f,1.f });
